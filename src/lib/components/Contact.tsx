...
export function Contact() {
  return (
    <Flex id="contact" className="contactBg">
      <Flex
        px={"5%"}
        py={{ base: "10%", lg: "5%" }}
      ...
      >
        <Text
          fontSize={{ base: "1.5rem", lg: "2.1rem", xl: "2.6rem" }}
          fontWeight={"bold"}
          color={"gray.100"}
        >
          CONTACT US
        ...
        >
          <Text
            ...
            fontWeight="500"
          >
            Ready to optimize your processes and elevate performance? Reach out
            to us today for the required training and staffing:
          </Text>
          <Flex
            w={{ base: "100%", lg: "30%" }}
          ...
          >
            <Flex gap={".7rem"} align={"center"}>
              ...
              <a href="mailto:info@themeanssolutions.com">
                <Text fontSize="1.1rem" fontWeight={"bold"} color={"gray.100"}>
